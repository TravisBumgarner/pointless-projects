...
const JackInBoxDice: React.FC<DiceRollerProps> = ({ params: { sides }, isRolling, setIsRolling }) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            {popped && (
              ...
              >
                ...
                <Typography sx={{ fontSize: 24, color: 'black' }}>{result}</Typography>
              </Box>
            )}
          </Box>
          {/* Crank */}
          ...
          >
            ...
            >
              <circle cx={20} cy={20} r={12} fill="#bbb" stroke="#333" strokeWidth={2} />
