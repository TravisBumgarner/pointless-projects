...
const Solo = () => {
  ...
  return (
    <Box>
      ...
      >
        <SelectRoller selectedRoller={selectedRoller} setSelectedRoller={handleSetSelectedRoller} />
      ...
      <Box sx={{ marginTop: SPACING.MEDIUM.PX }}>
        <Roller isRolling={isRolling} params={params} selectedRoller={selectedRoller} setIsRolling={setIsRolling} />
      </Box>
    </Box>
  )
}
